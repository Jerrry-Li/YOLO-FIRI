...
def get_latest_run(search_dir='.'):#获取last.pt
...
def check_online():#检测当前分之和版本是否一直，如果版本落后则提醒用户
...
def check_img_size(img_size, s=32):#检查图像尺寸是否为ｓ的整数倍，不是则调整尺寸
